...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="sidenav">
      ...
      <a href="ch13.php" class="highlight">XSS Challenge 13</a>
      <a href="ch14.php">XSS Challenge 14</a>
    </div>

    <div class="form">
    <form action="" method="post" name="form">
      Create a link? <input type="text" name="xss"><br>
      <input type="submit" name="submit" value="Submit">
      <br><br>

      <div class="prev">
         <a class="prev" href="ch12.php"><button type="button">Previous Challenge</button></a>
      </div>
      <div class="hyper">
         <a href="ch14.php"><button type="button">Next Challenge</button></a>
      </div>
